...
public class SwordComboController : MonoBehaviour
{
    ...
    {
        if (result.GestureClass == "S" && weapon.GetComponent<HandData>().WeaponInHand.GetComponent<SwordComboController>())
            Debug.Log("STINGER");
    }

    private void SwordPickedUp(GameObject weapon, HandData hand)
    {
